...
author: "Comparação do BMI médio de alunos de Eng. Sistemas e do PPGEE-UFMG"
output: pdf_document
---

## O Experimento
Neste estudo deseja-se comparar o BMI [[1](http://apps.who.int/bmi/index.jsp?introPage=intro_3.html)] médio de duas populações de estudantes, a saber: alunos de graduação em Engenharia de Sistemas e alunos de pós-graduação em Engenharia Elétrica. Neste caso estamos usando o BMI como um valor _proxy_ para variáveis relativas ao estilo de vida dos alunos (apesar das limitações conhecidas deste indicador [[2](http://www.nytimes.com/interactive/projects/cp/summer-of-science-2015/latest/how-often-is-bmi-misleading), [3](http://science.sciencemag.org/content/341/6148/856.summary), [4](http://www.medicalnewstoday.com/articles/265215.php)]), e nossa questão científica de interesse se relaciona ao efeito do curso na forma física dos alunos. 

Os dados relativos a ambas as turmas estão tabulados no arquivo [bmi_20161.csv](https://raw.githubusercontent.com/fcampelo/Design-and-Analysis-of-Experiments/master/data%20files/bmi_20161.csv), disponível no repositório Github da disciplina.
...
## Entrega
Os arquivos deverão ser enviados via _e-mail_ para o endereço [fcampelo@ufmg.br](fcampelo@ufmg.br). O título do e-mail deve seguir o padrão "**[EEE933_2016-1_EC02] Nome_da_equipe**" (sem as aspas). A data-limite para o recebimento dos arquivos é **segunda-feira (18/04) às 11:00h**