...
abstract: |
  Comparação do IMC médio de alunos do PPGEE-UFMG ao longo de dois semestres
...
Atenção: é interessante neste caso separar as amostras por sexo (masculino/feminino) e realizar testes independentes para as populações correspondentes.
...
## Entrega
Os arquivos deverão ser enviados via _e-mail_ para o endereço [fcampelo@ufmg.br](fcampelo@ufmg.br). O título do e-mail deve seguir o padrão "**[EEE933_2017-2_EC02] Nome_da_equipe**" (sem as aspas). A data-limite para o recebimento dos arquivos é **quarta-feira (17/10) às 23:55h**
